...
import file.FileCommandsVisitor;
...
public class FileDiff {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LineIterator file1 = FileUtils.lineIterator(new File("./file1.txt"), "utf-8");
        LineIterator file2 = FileUtils.lineIterator(new File("./file2.txt"), "utf-8");
